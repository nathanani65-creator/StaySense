...
<template>
  <div class="mx-auto flex min-h-[70vh] max-w-[440px] flex-col justify-center px-5 py-10">
    <div class="rounded-2xl border border-line bg-white p-7 shadow-card">
      <h1 class="text-[24px] font-bold text-ink">เข้าสู่ระบบ</h1>
      <p class="mt-1.5 text-[14.5px] text-ink-soft">เข้าสู่ระบบเพื่อบันทึกที่พักที่ชอบและดูประวัติการค้นหา</p>
      ...
      <p class="mt-5 text-center text-[14px] text-ink-soft">
        ยังไม่มีบัญชี?
        <RouterLink :to="{ path: '/register', query: route.query }" class="font-semibold text-indigo-600 hover:underline">สมัครสมาชิก</RouterLink>
      </p>
    </div>
  </div>
</template>
